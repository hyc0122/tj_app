<template>
  <div class="fileManagement">
    <t-card v-if="isElectron" :title="$t('settings.file.quickOpen')" bordered class="module-interactive--panel">
      <div class="folderList">
        <!-- 快捷路径行：小幅悬浮反馈 -->
        <div v-for="item in folderList" :key="item.path" class="folderItem module-interactive">
