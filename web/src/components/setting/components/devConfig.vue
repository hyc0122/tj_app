    ...
    <t-form label-align="top">
      ...
      <t-dialog
        ...
        <div class="localStorageDialogBody">
          ...
          <CodeEditor v-model:value="localStorageForm.value" language="json" :theme="monacoTheme" :height="500" :options="localStorageEditorOptions" />
        </div>
      </t-dialog>
    </t-form>
  </div>
...
const { isElectron, themeSetting } = storeToRefs(settingStore());
// Monaco 仅支持 vs/vs-dark；cyberpunk 映射为 vs-dark
