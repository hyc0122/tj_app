<template>
  <div class="dbConfig">
    <!-- 数据库概览：设置页快捷操作卡片 -->
    <t-card class="actionItem module-interactive">
    ...
    <!-- 清空指定表：含 Select，卡片本身可悬停但不改弹层 -->
    <t-card class="actionItem clearTableCard module-interactive">
      <div class="actionInfo">
...
async function exportData() {
  ...
  try {
    ...
    a.href = url;
    a.download = `tianjiang-backup-${Date.now()}.json`;
