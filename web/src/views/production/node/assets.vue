    ...
    <div class="content">
      <div class="cardGrid">
        <div v-for="asset in assets" :key="asset.id" class="assetItemBox">
          <!-- 角色/资产原件瓦片 -->
          <t-card class="assetCard module-interactive">
          ...
          <div class="deriveAssets">
            <t-card v-for="(item, index) in asset.derive" :key="index" class="assetCard module-interactive" @click="generateAssetsImage(item, asset.src)" tabindex="0" @keydown.enter.prevent="generateAssetsImage(item, asset.src)">
