...
exports.buildShotTableAnalysisInstruction = exports.buildShotTableAnalysisJsonSchema = exports.SHOT_TABLE_ANALYSIS_SCHEMA_NAME = void 0;
const defaults_1 = require("./defaults");
const column_contract_1 = require("./column-contract");
exports.SHOT_TABLE_ANALYSIS_SCHEMA_NAME = 'tapcanvas_shot_table_analysis_v1';
const buildVideoEvidenceStringProperty = (key, label) => {
    if (key === '节拍数') {
        return {
            type: 'string',
            enum: [''],
...
const buildStringProperties = (entries) => Object.fromEntries(entries.map(({ key, label }) => [key, buildVideoEvidenceStringProperty(key, label)]));
const buildShotTableAnalysisJsonSchema = (columns = defaults_1.VIDEO_EVIDENCE_SHOT_TABLE_COLUMNS) => {
    ...
    const overviewKeys = [...defaults_1.SHOT_TABLE_OVERVIEW_ORDER];
...
exports.buildShotTableAnalysisJsonSchema = buildShotTableAnalysisJsonSchema;
const buildShotTableAnalysisInstruction = (options = {}) => {
...
exports.buildShotTableAnalysisInstruction = buildShotTableAnalysisInstruction;
