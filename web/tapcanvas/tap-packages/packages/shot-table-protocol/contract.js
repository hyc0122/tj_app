...
exports.SHOT_TABLE_ANALYSIS_OUTPUT_MODE = exports.buildShotTableOutputContract = void 0;
const defaults_1 = require("./defaults");
const buildShotTableOutputContract = (columns = defaults_1.DEFAULT_SHOT_TABLE_COLUMNS) => {
    const labels = new Set();
    for (const column of columns) {
        if (labels.has(column.label))
            throw new Error(`当前分镜表存在重复列名：“${column.label}”。`);
...
exports.buildShotTableOutputContract = buildShotTableOutputContract;
exports.SHOT_TABLE_ANALYSIS_OUTPUT_MODE = 'shot-table-v1';
