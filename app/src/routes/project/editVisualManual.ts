...
import { z } from "zod";
import { resolveAccountSkillPath } from "@/tianjiang/skills/account-skills";
...
export default router.post(
  ...
  async (req, res) => {
    try {
      ...
      const { skillsRoot, styleDir: mainPath, styleId: safeStyle } = await resolveManualStyleDirectory(
        u.getPath(),
        "art_skills",
        stylePath,
        { mustExist: true },
